...
alb_record_name = "dev-us.til-challenge.com"
...
public_key_path = "bastion_ssh_key/dev-use1-bastion-key.pub"

# ecs 주입 변수(task, service)
services = {
  user_service = {
    container_name        = "dev-use1-user-container"
    service_name          = "dev-use1-user-service"
    container_port        = 8081
    ecs_cpu               = 2048
    ecs_memory            = 4096
    enable_alb            = false
    family                = "dev-use1-user-service-task"
    host_port             = 8081
  ...
  notification_service = {
    container_name        = "dev-use1-notification-container"
    service_name          = "dev-use1-notification-service"
    container_port        = 8082
    ecs_cpu               = 2048
    ecs_memory            = 4096
    enable_alb            = false
    family                = "dev-use1-notification-service-task"
    host_port             = 8082
  ...
  search_service = {
    container_name        = "dev-use1-search-container"
    service_name          = "dev-use1-search-service"
    container_port        = 8083
    ecs_cpu               = 2048
    ecs_memory            = 4096
    enable_alb            = false
    family                = "dev-use1-search-service-task"
    host_port             = 8083
  ...
  reservation_service = {
    container_name        = "dev-use1-reservation-container"
    service_name          = "dev-use1-reservation-service"
    container_port        = 8084
    ecs_cpu               = 2048
    ecs_memory            = 4096
    enable_alb            = false
    family                = "dev-use1-reservation-service-task"
    host_port             = 8084
...
authorization_service_config = {
  container_name        = "dev-use1-auth-container"
  service_name          = "dev-use1-auth-service"
  container_port        = 8000
  ecs_cpu               = 2048
  ecs_memory            = 4096
  enable_alb            = true
  family                = "dev-use1-auth-service-task"
  host_port             = 8000
